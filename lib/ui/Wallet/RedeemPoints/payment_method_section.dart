...
import 'package:nexus_app/ui/Wallet/RedeemPoints/preferred_payment_tile.dart';

class PaymentMethodSection extends StatefulWidget {
  final Function(String) onChange;
  final Function(bool) panVerified;
...
class _PaymentMethodSectionState extends State<PaymentMethodSection> {
  ...
  Widget build(BuildContext context) {
    widget.kycData.panNumber != null
        ? widget.panVerified(true)
        : widget.panVerified(false);
    return Column(
      ...
      children: [
        ...
        widget.kycData.paytmNumber != null
            ? PreferredPayment(
                preferred: widget.kycData.preferredPaymentMode == "PAYTM"
                    ...
                    : false,
                title: "Paytm",
                subtitle: "+91-${widget.kycData.paytmNumber}",
                radioButton: Radio(
        ...
        widget.kycData.accountNumber != null
            ? PreferredPayment(
                preferred: widget.kycData.preferredPaymentMode == "BANKTRANSFER"
                    ...
                    : false,
                title: "Bank Account",
                subtitle: "${widget.kycData.accountNumber}",
                radioButton: Radio(
                  groupValue: groupValue,
                  value: "BANKTRANSFER",
                  onChanged: (_) {
        ...
        widget.kycData.vpaAddress != null
            ? PreferredPayment(
                ...
                title: "UPI",
                subtitle: "${widget.kycData.vpaAddress}",
                radioButton: Radio(
                  groupValue: groupValue,
                  value: "VPA",
                  onChanged: (_) {
