...
class ExploreAllTasksScreen extends StatefulWidget {
  @override
  _ExploreAllTasksScreenState createState() => _ExploreAllTasksScreenState();
}

class _ExploreAllTasksScreenState extends State<ExploreAllTasksScreen> {
  reloadPage() {
    setState(() {});
  }
  ...
  Future getContent() async {
    ...
    await ApiBase()
        .get(context, "/mlm-service/getActivitiesByPartnerId", params, null)
        .then((value) {
