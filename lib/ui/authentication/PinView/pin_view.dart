...
import 'package:nexus_app/ui/authentication/PinView/sms_listner.dart';
...
class _PinViewState extends State<PinView> {
  ...
  Widget _singlePinView(int index) {
    ...
    if (_focusNodes[0].hasFocus == false &&
        _focusNodes[1].hasFocus == false &&
        _focusNodes[2].hasFocus == false &&
        _focusNodes[3].hasFocus == false) {
      FocusScope.of(context).requestFocus(_focusNodes[0]);
    }
    return Flexible(
        flex: 3,
